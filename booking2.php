<?php
    ...
    if (isset($_POST['book'])) {
    	if (isset($_POST['name']) && isset($_POST['email']) && isset($_POST['ticketNum']) && isset($_POST['date']) && isset($_POST['time'])){
		    				...
		    				<th style="padding: 1vw; vertical-align: top; text-align: left;">
		    					...
		    					<form  method="post" action="#">
		    						<label for="inputEmail">From <span style="color: #FF0000">*</span></label>
                           			<input type="hidden" name="fromEmail" id="fromEmail" class="form-control"  value="alfredveniegasmendoza11@gmail.com" readonly required autofocus>
                           		
                           			<input type="hidden" name="subject" id="subject" class="form-control"  value="Movie Booking" >
                           			<input type="hidden" name="message" id="message" class="form-control"  value="Thank you for purchasing a ticket for <?php echo $row['title'];?> God bless!" ><br>

		    						Name:&nbsp&nbsp<input style="width:250px; padding:8px" type="text" id="name" name="name" value="<?php echo $name;?>" required/><span class="errMsg"> <?php echo $errName;?></span><br><br>
		    						Email:&nbsp&nbsp<input style="width:250px;padding:8px" type="text" id="email" name="email" value="<?php echo $email;?>" required/><span class="errMsg"> <?php echo $errEmail;?></span><br><br>
		    						Enter number of ticket:&nbsp&nbsp<input style="width:120px;padding:8px" type="text" id="ticketNum" name="ticketNum" value="<?php echo $ticketNum;?>" required/><span class="errMsg"> <?php echo $errTicketNum;?></span><br><br>
			    					...
			    					<br>Select date:
			    					<input class="form-modal" type="date" name="date" value="<?php echo $date;?>" required><span class="errMsg"> <?php echo $errDate;?></span><br><br>
			    					Select time:
			    					<?php
			    						if($row['time']=='A'){
			    					?>
		    						...
		    						<div class="yes select" id="yes-div" style="display: none;">
			    						...
			    						<input type="checkbox" id="regular">Regular<br>
			    							...
			    							&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="checkbox" value="small" id="regular-small-check">Small (Php 30)
												<span class="number">
											...
											<br>
			    							&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="checkbox" value="medium" id="regular-medium-check">Medium (Php 50)
			    							<span class="number">
											...
											<br>
			    							&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="checkbox" value="large" id="regular-large-check">Large (Php 75)
			    							<span class="number">
			    						...
			    						<div class="cheese-select" style="display: none;">
			    							&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="checkbox" value="small" id="cheese-small-check">Small (Php 45)
												<span class="number">
											...
											<br>
			    							&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="checkbox" value="medium" id="cheese-medium-check">Medium (Php 60)
			    							<span class="number">
											...
											<br>
			    							&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="checkbox" value="large" id="cheese-large-check">Large (Php 85)
			    							<span class="number">
			    						...
			    						<div class="caramel-select" style="display: none;">
			    							&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="checkbox" value="small" id="caramel-small-check">Small (Php 50)
												<span class="number">
											...
											<br>
			    							&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="checkbox" value="medium" id="caramel-medium-check">Medium (Php 70)
			    							<span class="number">
											...
											<br>
			    							&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="checkbox" value="large" id="caramel-large-check">Large (Php 90)
			    							<span class="number">
			    						...
			    						<input type="checkbox" id="cola">Coca-cola<br>
			    							...
			    							&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="checkbox" value="small" id="cola-small-check">Small (Php 15)
												<span class="number">
											...
											<br>
			    							&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="checkbox" value="medium" id="cola-medium-check">Medium (Php 30)
			    							<span class="number">
											...
											<br>
			    							&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="checkbox" value="large" id="cola-large-check">Large (Php 50)
			    							<span class="number">
			    						...
			    						<div class="tea-select" style="display: none;">
			    							&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="checkbox" value="small" id="tea-small-check">Small (Php 12)
												<span class="number">
											...
											<br>
			    							&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="checkbox" value="medium" id="tea-medium-check">Medium (Php 20)
			    							<span class="number">
											...
											<br>
			    							&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="checkbox" value="large" id="tea-large-check">Large (Php 30)
			    							<span class="number">
			    						...
			    						<div class="royal-select" style="display: none;">
			    							&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="checkbox" value="small" id="royal-small-check">Small (Php 15)
												<span class="number">
											...
											<br>
			    							&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="checkbox" value="medium" id="royal-medium-check">Medium (Php 20)
			    							<span class="number">
											...
											<br>
			    							&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="checkbox" value="large" id="royal-large-check">Large (Php 30)
			    							<span class="number">
